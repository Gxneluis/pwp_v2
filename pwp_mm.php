...
<head>
	...
	<style><?php include 'css/css_mm.css'; ?></style>
	<script><?php include 'js/js_mm.js'; ?></script>
</head>
<body>
<br /><br /><br />
<?php
...
<div class="cViewReport">
	<div class="tab">
		<button class="tabLinks active " id="idBtn_001_mm">for Approval</button>
		<button class="tabLinks" id="idBtn_002_mm">Rejected</button>
		<button class="tabLinks " id="idBtn_003_mm">for GM</button>
		<button class="tabLinks " id="idBtn_004_mm">Completed</button>
	</div>
	<div id="idTab001" class="tabContent">
		<div>
			<table border="1" id="idTbl_mm_001">
				<tr>
				<th class="tblVw00" >#</th>
	...
	<div id="idTab002" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_mm_002">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="idTab003" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_mm_003">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="idTab004" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_mm_004">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="idDiv_Request" class="cReview tabDtl" >
		<div id="cDivDtl" class="" >
			<div class="div_bold grid-cont-pwp-req" >
				...
				<div id="" class="dtl-t14" style="display:none;">TOTAL '.$iCurrYear.' TARGET</div>
				...
				<div id="" class="dtl-i15" style="display:none;"><input type="text" id="idTtlTrg" class="wid-45" ></div>
				...
				<div id="" class="dtl-i18" style="display:none;">Diff.<input type="text" id="idTtlDif" class="wid-40" ></div>
				<div id="" class="dtl-i19">Diff.<input type="text" id="idYTDDif" class="wid-40" ></div>
				<div id="" class="dtl-i20" style="display:none;">Growth<input type="text" id="idTtlGrw" class="wid-40" ></div>

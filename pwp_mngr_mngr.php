...
<head>
	...
	<style><?php include 'css/css_mngr.css'; ?></style>
	<script><?php include 'js/js_pwp_mngr.js'; ?></script>
</head>
<body>
</head>
<body>
...
include 'nav_bar.php';
echo '
<div class="cViewReport_mngr">
	<div class="tab">
		<button class="tabLinks active" id="idBtn_Pending_mngr">for Approval</button>
		<button class="tabLinks" id="idBtn_Rjct_mngr">Rejected</button>
		<button class="tabLinks" id="idBtn_Previous_mngr">Previous</button>
	</div>
	<div id="cDiv_pending_mngr" class="tabContent">
		<div>
			<table border="1" id="idTbl_Pend_mngr">
				<tr>
				<th class="tblVw00" >#</th>
	...
	<div id="cDiv_preview_mngr" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_Prev_mngr">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="cDiv_Rjct_mngr" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_Rjct_mngr">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>

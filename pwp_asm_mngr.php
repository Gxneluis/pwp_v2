...
<head>
	...
	<style><?php include 'css/css_asm.css'; ?></style>
	<script><?php include 'js/js_pwp_asm.js'; ?></script>
</head>
<body>
</head>
<body>
...
include 'nav_bar.php';
echo '
<div class="cViewReport_asm">
	<div class="tab">
		<button class="tabLinks active" id="idBtn_Pend_asm">for Approval</button>
		<button class="tabLinks" id="idBtn_Rjct_asm">Rejected</button>
		<button class="tabLinks" id="idBtn_Prev_asm">Previous</button>
	</div>
	<div id="cDiv_pend_asm" class="tabContent">
		<div>
			<table border="1" id="idTbl_Pend_asm">
				<tr>
				<th class="tblVw00" >#</th>
	...
	<div id="cDiv_prev_asm" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_Prev_asm">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="cDiv_Rjct_asm" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_Rjct_asm">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="idDiv_Request" class="cReview tabDtl" >
		<div id="cDivDtl" class="" >
			<div class="div_bold grid-cont-pwp-req" >
				...
				<div class="dtl-f4" ><input type="text" id="idPrjtdSale" class=""></div>
				<div class="dtl-f5" >Projected Cost</div>
				<div class="dtl-f6" ><input type="text" id="idPrjtdCost" class=""></div>
				<div class="dtl-f7" >Cost to Sales Ratio (%)</div>
				<div class="dtl-f8" ><input type="text" id="idCostToSalesRatio" class="" ><input type="text" id="idCtoSRatPer" class=""></div>
		...
		<button id="idBtn_Reviewed">Approve</button>

...
<head>
	...
	<style><?php include 'css/css_vw.css'; ?></style>
	<script><?php include 'js/js_vw.js'; ?></script>
</head>
<body>
<br /><br /><br />
<?php
...
<div class="cViewReport">
	<div class="tab">
		<button class="tabLinks active " id="idBtn_vw_asm">for ASM Approval</button>
		<button class="tabLinks " id="idBtn_vw_ash">for ASH Approval</button>
		<button class="tabLinks " id="idBtn_vw_mm">for MM Approval</button>
		<button class="tabLinks " id="idBtn_vw_gm">APPROVED</button>
	</div>
	<div id="idVwTab_ASM" class="tabContent">
		<div>
			<table border="1" id="idTbl_ASM_Pend">
				<tr>
				<th class="tblVw00" >#</th>
	...
	<div id="idVwTab_ASH" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_ASH_Pend">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="idVwTab_MM" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_MM_Pend">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
	...
	<div id="idVwTab_GM" class="tabContent" style="display:none">
		<div>
			<table border="1" id="idTbl_GM_Pend">
				<tr>
				<th class="tblVw00" >#</th>
				<th class="tblVw01" >PWP Date</th>
				<th class="tblVw02" >Activity Type</th>
